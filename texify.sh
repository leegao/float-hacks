...
read -p "[readme2tex] ${color}READOTHER.md$reset has changed; would you like to update ${color}README.md$reset as well? This will run
  ...
  > python -m readme2tex --output ${color}README.md$reset --readme ${color}READOTHER.md$reset --branch ${color}svgs$reset --svgdir 'svgs'
...
python -m readme2tex --output README.md --readme READOTHER.md --branch svgs --svgdir 'svgs'
echo $reset
